...
def _add_cost_category_columns(inspector) -> None:
    ...
    if "category_id" not in columns:
        op.add_column("cost_records", sa.Column("category_id", sa.Integer(), nullable=True))
...
def _create_indexes(inspector) -> None:
    index_specs = [
        ("cost_records", "ix_cost_records_farm_date_deleted", ["farm_id", "record_date", "deleted_at"]),
        ("cost_records", "ix_cost_records_farm_type_date", ["farm_id", "record_type", "record_date"]),
        ("crop_cycles", "ix_crop_cycles_farm_status_start", ["farm_id", "status", "start_date"]),
        ("farm_logs", "ix_farm_logs_farm_operation_date", ["farm_id", "operation_date"]),
        ("conversation_messages", "ix_conversation_messages_conversation_created", ["conversation_id", "created_at"]),
        ("trace_records", "ix_trace_records_request_round_id", ["request_id", "round_index", "id"]),
...
def _ensure_fk_fallback_indexes(inspector) -> None:
    fallback_specs = [
        ...
        ("conversation_messages", "ix_conversation_messages_conversation_id", ["conversation_id"]),
...
def _add_foreign_keys(inspector) -> None:
    fk_specs = [
        ("cost_categories", "fk_cost_categories_farm_id", ["farm_id"], "farms", ["id"], "RESTRICT"),
        ("cost_records", "fk_cost_records_category_id", ["category_id"], "cost_categories", ["id"], "RESTRICT"),
        ("cost_records", "fk_cost_records_cycle_id", ["cycle_id"], "crop_cycles", ["id"], "SET NULL"),
        ("feedback_records", "fk_feedback_records_user_id", ["user_id"], "users", ["id"], "RESTRICT"),
        ("user_settings", "fk_user_settings_user_id", ["user_id"], "users", ["id"], "CASCADE"),
        ("token_daily_stats", "fk_token_daily_stats_farm_id", ["farm_id"], "farms", ["id"], "RESTRICT"),
        ("token_daily_stats", "fk_token_daily_stats_user_id", ["user_id"], "users", ["id"], "SET NULL"),
        ("trace_records", "fk_trace_records_farm_id", ["farm_id"], "farms", ["id"], "RESTRICT"),
        ("trace_records", "fk_trace_records_message_id", ["conversation_message_id"], "conversation_messages", ["id"], "SET NULL"),
        ("simulation_runs", "fk_simulation_runs_farm_id", ["farm_id"], "farms", ["id"], "RESTRICT"),
        ("simulation_results", "fk_simulation_results_farm_id", ["farm_id"], "farms", ["id"], "RESTRICT"),
    ]
...
def _alter_mysql_types() -> None:
    op.alter_column("trace_records", "input_data", type_=sa.JSON(), existing_nullable=True)
    op.alter_column("trace_records", "output_data", type_=sa.JSON(), existing_nullable=True)
    op.alter_column("trace_records", "token_usage", type_=sa.JSON(), existing_nullable=True)
    op.alter_column("trace_records", "start_time", type_=sa.DateTime(), existing_nullable=True)
    op.alter_column("trace_records", "end_time", type_=sa.DateTime(), existing_nullable=True)
    op.alter_column("token_daily_stats", "date", type_=sa.Date(), existing_nullable=False)
    op.alter_column("cycle_stages", "is_current", type_=sa.Boolean(), existing_nullable=True)
    for column in [
        "errors_json",
        "db_diff_json",
        ...
        op.alter_column("simulation_results", column, type_=sa.JSON(), existing_nullable=True)


def _restore_mysql_types() -> None:
    op.alter_column("trace_records", "input_data", type_=sa.Text(), existing_nullable=True)
    op.alter_column("trace_records", "output_data", type_=sa.Text(), existing_nullable=True)
    op.alter_column("trace_records", "token_usage", type_=sa.Text(), existing_nullable=True)
    op.alter_column("trace_records", "start_time", type_=sa.String(length=32), existing_nullable=True)
    op.alter_column("trace_records", "end_time", type_=sa.String(length=32), existing_nullable=True)
    op.alter_column("token_daily_stats", "date", type_=sa.String(length=10), existing_nullable=False)
    op.alter_column("cycle_stages", "is_current", type_=sa.Integer(), existing_nullable=True)
    for column in [
        "errors_json",
        "db_diff_json",
        "extracted_claims_json",
        ...
        op.alter_column("simulation_results", column, type_=sa.Text(), existing_nullable=True)
