...
B_WRITE_CASES: list[EvalCase] = [
    ...
    EvalCase("w-log-1", "B_WRITE", "今天浇水了", "log_farm_activity"),
    EvalCase("w-log-2", "B_WRITE", "记一下昨天施肥", "log_farm_activity"),
    EvalCase("w-cycle-1", "B_WRITE", "新建茬口种西瓜", "create_crop_cycle"),
