...
from app.domains.users.errors import invalid_credentials_error, register_failed_error
from app.domains.users.auth_schemas import (
    FarmProfileResponse,
    LoginRequest,
    RegisterRequest,
    TokenResponse,
...
from app.domains.users.service import login as auth_login
from app.domains.users.service import register as auth_register
from app.domains.farm.service import (
