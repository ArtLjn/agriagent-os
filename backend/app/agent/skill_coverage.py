...
_COVERAGE_ENTRIES: tuple[SkillCoverageEntry, ...] = (
    ...
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="get_cost_summary|get_cost_analytics",
        permission_level="read",
        risk_level="low",
        rationale="查询账务、利润和趋势由现有读 Skill 覆盖。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
    ...
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="get_cost_categories|manage_cost_categories",
        permission_level="read|write_confirm",
        risk_level="low|medium",
        rationale="分类查询、创建和删除由专用分类 Skill 覆盖，删除需确认。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="create_crop_template",
        permission_level="write_confirm",
        risk_level="medium",
        rationale="缺模板时由建模板 Skill 覆盖。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="get_crop_templates|manage_crop_templates",
        permission_level="read|write_confirm",
        risk_level="low|high",
    ...
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="create_crop_cycle|get_crop_cycle_info|update_crop_cycle|update_crop_stage",
        permission_level="write_confirm",
        risk_level="medium",
        rationale="茬口创建、查询、起始日期和阶段更新已有 Skill 覆盖。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
        ...
        permission_level="write_confirm",
        risk_level="high",
        rationale="删除茬口影响历史农事和账务，已通过高风险确认型 Skill 暴露。",
        priority=CoveragePriority.MEDIUM,
        test_status="covered",
    ),
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="log_farm_activity|get_recent_farm_logs|manage_farm_logs",
        permission_level="write_confirm",
        risk_level="medium",
        rationale="创建、查询、编辑和删除农事记录均由 Skill 覆盖，变更需确认。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="get_planting_units|manage_planting_units",
        permission_level="read|write_confirm",
        risk_level="low|medium",
        rationale="棚/地块查询、创建、更新和删除由种植单元 Skill 覆盖。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="get_workers|manage_workers",
        permission_level="read|write_confirm",
        risk_level="low|medium",
        rationale="工人当前列表、创建、更新、停用和恢复由专用 Skill 覆盖。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
    ...
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="create_cost_record|get_debt_summary|settle_debt",
        permission_level="read|write_confirm",
        risk_level="low|medium",
        rationale="赊账创建、未结统计和结清由专用记账、债务查询与还款 Skill 覆盖。",
        priority=CoveragePriority.HIGH,
        test_status="covered",
    ),
    SkillCoverageEntry(
    ...
    SkillCoverageEntry(
        ...
        status=CoverageStatus.COVERED_BY_SKILL,
        skill_name="get_user_settings|manage_user_settings",
        permission_level="read|write_confirm",
        risk_level="low|medium",
        rationale="当前用户设置查询和白名单配置项更新由专用 Skill 覆盖。",
        priority=CoveragePriority.MEDIUM,
        test_status="covered",
    ),
    SkillCoverageEntry(
