...
WEATHER_SENSITIVE_OPERATION_HINTS = (
    "打药",
    "施药",
    "喷药",
    "浇水",
...
WEB_CURRENT_EVENT_TIME_HINTS = ("最近", "最新", "近日", "近来", "今天", "刚刚")
WEB_CURRENT_EVENT_TOPIC_HINTS = (
    "活动",
    "动态",
    "消息",
    "新闻",
