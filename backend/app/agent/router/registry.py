...
CATALOG_REGISTRY: dict[str, dict] = {
    ...
    "get_crop_cycle_info": {
        ...
        "risk": "read",
        "entities": ["crop_cycle"],
        "trigger_examples": ["查一下水稻茬口", "看一下3号茬口"],
    ...
    "get_crop_cycles": {
        "domain": "planting",
        "intents": ["query_crop_cycles"],
        "risk": "read",
        "entities": ["crop_cycle"],
        "trigger_examples": ["我的茬口", "有哪些茬口", "茬口列表"],
        "anti_examples": ["看一下3号茬口", "农场整体情况"],
        "context_dependencies": ["crop_cycles"],
        "candidate_group": "planting_read",
    },
    "create_crop_cycle": {
        "domain": "planting",
        "intents": ["create_crop_cycle"],
        "risk": "write_confirm",
        "entities": ["crop_cycle", "crop_template", "planting_unit"],
        "trigger_examples": ["帮我建个黑布林茬口30亩", "新建一个黑布林种植茬口"],
        "anti_examples": ["黑布林怎么种", "有哪些茬口"],
