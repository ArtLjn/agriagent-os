  ...
  it('长官方预警独立展示，不占用农事摘要标题', async () => {
    mockedGetForecast.mockResolvedValue({
      ...
      warnings: [
        ...
        '相城区气象台发布雷雨黄色预警[Ⅲ级/较重]: 预计未来3小时我区大部分街道（镇）将出现雷阵雨天气。',
        '姑苏区气象台发布大风蓝色预警[Ⅳ级/一般]: 预计今天夜里我区大部分街道（镇）将出现5到6级阵风。',
        '工业园区气象台发布高温黄色预警[Ⅲ级/较重]: 预计明天白天我区大部分街道（镇）将出现35℃以上高温。',
    ...
    expect(screen.getByText(/苏州市气象台发布大风蓝色预警/)).toBeInTheDocument();
  });
});
