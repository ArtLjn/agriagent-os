...
目标：**从 10000 条会话中自动找出最值得标注的 100 条**，让标注员默认按风险倒序而非时间倒序查看。这是数据飞轮从「能跑」到「能转」的关键升级，对应 [design-spec 01.06 § 9](../../../docs/farm-manager-design-spec/01_正式设计/06_数据飞轮与评测.md) 已落地设计。
