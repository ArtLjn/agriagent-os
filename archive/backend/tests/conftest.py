...
def clean_db(request):
    ...
    app.dependency_overrides[get_effective_auth_context_farm] = (
        override_get_current_farm
    )
...
@pytest.fixture()
def agent_state_with_farm(farm_id: int) -> AgentState:
    """包含可信 farm_id 的最小 AgentState。"""
    return {
