...
@pytest.mark.parametrize("message", ["黑布林怎么种", "怎么种小麦"])
def test_planting_advice_tutorial_prefix_routes_to_chitchat(message: str) -> None:
    """朴素模式下,"X怎么种" 走 ChitchatClassifier 短路。"""
...
def test_planting_advice_business_query_keeps_read_frame() -> None:
    """朴素模式下,"种小麦要注意什么" 不含教程词,RuleIntentClassifier 识别为
    query_planting_advice frame,精确选 get_farm_status。"""
    tools = [_tool("get_farm_status"), _tool("manage_crop_cycle")]
