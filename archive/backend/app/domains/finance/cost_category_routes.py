...
from app.domains.finance.cost_category_schemas import CostCategoryCreate, CostCategoryResponse
...
def get_categories(
    farm: Farm = Depends(get_current_farm), db: Session = Depends(get_db)
):
