        ...
        *,
        ...
        try:
            ...
            log_silent_exception(
                ...
                function="check_write_plan",
                agent_event="reflector.check_write_plan",
                exc=exc,
            )
            return self._record(
        ...
        *,
        ...
        try:
            ...
            log_silent_exception(
                logger,
                level=logging.WARNING,
                function="check_pending_plan",
                agent_event="reflector.check_pending_plan",
                exc=exc,
            )
            return self._record(
                self._fail_closed_result(
        ...
        *,
        ...
        try:
            ...
            log_silent_exception(
                logger,
                level=logging.WARNING,
                function="check_tool_response",
                agent_event="reflector.check_tool_response",
                exc=exc,
            )
