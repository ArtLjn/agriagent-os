...
async def _wait_for_preload(preload_task) -> None:
    ...
    try:
        ...
        log_silent_exception(
            logger,
            level=logging.DEBUG,
            function="_wait_for_preload",
            agent_event="llm_node_steps.wait_for_preload",
            exc=exc,
        )
        pass
    ...
    *,
    ...
    try:
        ...
        log_silent_exception(
            ...
            function="_retry_discarded_tool_result_reply",
            agent_event="llm_node_steps.retry_discarded_tool_result_reply",
            exc=exc,
        )
        return response
    ...
    *,
    ...
    try:
        ...
        log_silent_exception(
            logger,
            level=logging.DEBUG,
            function="_record_tool_result_regeneration_trace",
            agent_event="llm_node_steps.record_tool_result_regeneration_trace",
            exc=exc,
        )
        return
