...
def _build_circuit_key(llm_instance) -> str:
    ...
    try:
        ...
        log_silent_exception(
            logger,
            level=logging.DEBUG,
            function="_build_circuit_key",
            agent_event="llm_support.build_circuit_key.base_url",
            exc=exc,
        )
        pass
    ...
    try:
        ...
        log_silent_exception(
            ...
            level=logging.DEBUG,
            function="_build_circuit_key",
            agent_event="llm_support.build_circuit_key.manager",
            exc=exc,
        )
        pass
...
def _record_llm_success(circuit_key: str) -> None:
    ...
    try:
        ...
        log_silent_exception(
            logger,
            level=logging.DEBUG,
            function="_record_llm_success",
            agent_event="llm_support.record_llm_success",
            exc=exc,
        )
        pass
