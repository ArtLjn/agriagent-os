...
| `manage_crop_cycle` | `create_crop_cycle`、`get_crop_cycles`、`get_crop_cycle_info`、`update_crop_cycle`、`update_crop_stage`、`delete_crop_cycle` |
...
| `backend/app/agent/skills/update-crop-cycle/`、`update-crop-stage/`、`delete-crop-cycle/` | `manage_crop_cycle` 接管更新和删除时 |
...
| `backend/app/agent/skills/log-farm-activity/`、`farm-logs/`、`manage-farm-logs/` | `manage_farm_logs` 接管日志时 |
| `backend/app/agent/skills/get-user-settings/`、`manage-user-settings/` | `manage_settings` 接管设置时 |
