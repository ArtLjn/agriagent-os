...
- [x] **Step 1: 写失败测试，验证结果模型可表达 handled/unhandled/confirm/cancel/fail**
...
- [x] **Step 1: 写失败测试，验证确认执行 create_cost_record 走统一服务**
...
- [x] **Step 1: 修改测试 patch 点，验证兼容入口调用 executor**
...
- [x] **Step 3: 修改 service 使用统一 pending executor**
...
- [x] **Step 3: 修改 Advisor pending 分支**
...
- [x] **Step 4: 跑 Advisor 和 service 相关测试**
...
- [x] **Step 1: 写 Application use case 测试**
...
- [x] **Step 3: 在 Application 中实现非流式生命周期**
...
- [x] **Step 4: 跑 Application 测试和 API 聊天测试**
...
- [x] **Step 3: 让 `stream_chat_events` 不再调用 `stream_chat_with_agent`**
...
- [x] **Step 1: 写 Runtime prepared input 架构测试**
...
- [x] **Step 3: 增加可选 prepared runtime 字段**
...
- [x] **Step 4: 在 nodes 中优先读取 prepared 字段**
...
- [x] **Step 1: 写架构测试，防止重复 pending 执行入口**
